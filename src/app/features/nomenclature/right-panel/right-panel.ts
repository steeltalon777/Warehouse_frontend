...
@Component({
  ...
  standalone: true,
  imports: [ItemEditFormComponent, CategoryEditFormComponent],
  template: `
    <div class="wh-panel right-panel" [class.empty]="!selectedNode()">
      @if (selectedNode(); as node) {
        ...
        <div class="wh-empty empty-state">
          ...
          <h3 class="empty-title">Выберите категорию или ТМЦ</h3>
          <p class="empty-desc">
